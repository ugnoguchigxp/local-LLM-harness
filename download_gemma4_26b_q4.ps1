# download_gemma4_26b_q4.ps1
# Script to download Gemma 4 26B Instruct (Q4_K_M) from Hugging Face
...
$outputPath = Join-Path $modelsDir "google_gemma-4-26B-A4B-it-Q4_K_M.gguf"
...
Write-Host "[*] Starting download of Gemma 4 26B Instruct (Q4_K_M)..." -ForegroundColor Yellow
